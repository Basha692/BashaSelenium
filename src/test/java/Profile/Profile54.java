...
public class Profile54 extends OnboardingModalsTest {
	...
	public void validateOnboardingModalsForFirstTimeUser() throws Exception {
		try {
			test.log(LogStatus.INFO, "Validate Onboarding modals for first time users");
			pf.getOnboardingModalsPageInstance(ob).validateOnboardingModals();
	 ...
	 */
	@Test(dependsOnMethods = "validateOnboardingModalsForFirstTimeUser")
	@Parameters({"username", "password"})
