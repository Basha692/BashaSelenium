...
public class Profile65 extends TestBase {
	...
	public void validateENWToNeonUsingPrivacyLink(String enwProfileFlyout,
			String link) throws Exception {
		try {
			test.log(LogStatus.INFO, "Navigate to Neon application from EndNoteWeb using Privacy link");
			...
			test.log(LogStatus.FAIL, "ENW to Neon navigation using Privacy link not done");
			status = 2;// excel
			// print full stack trace
			StringWriter errors = new StringWriter();
			t.printStackTrace(new PrintWriter(errors));
