 ...
 *
 */
public class Profile27 extends TestBase {
	...
	public void profileCountryTypeaheadUpdate(String countryTypeahead,
		...
		try {
			...
			test.log(LogStatus.INFO, "Snapshot below: " + test
					.addScreenCapture(captureScreenshot(this.getClass().getSimpleName() + "_COUNTRY_TYPEAHEAD_FAIL")));// screenshot
			closeBrowser();
		}
	}
