...
public class Profile22 extends TestBase {
	...
	public void testNavigateToPostRVPage() throws Exception {
		try {
			...
			test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(
					captureScreenshot(this.getClass().getSimpleName() + "recordView_post_title_validation_fail")));// screenshot
			closeBrowser();
		}
