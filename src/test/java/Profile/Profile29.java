...
public class Profile29 extends TestBase {
	...
	public void topicTypeaheadValidation(String oneChar,
		...
		try {
			...
			pf.getProfilePageInstance(ob).topicTypeaheadOptionsMinChars(oneChar, twoChar);
