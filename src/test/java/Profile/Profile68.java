...
public class Profile68 extends OnboardingModalsTest {
	...
	public void clickWelcomeModalOutside() throws Exception {
		try {
			test.log(LogStatus.INFO, "Click Profile onboarding modal outside");
			test.log(LogStatus.INFO, "Validate User will be sent right to their desired location in Neon.");
			pf.getOnboardingModalsPageInstance(ob).clickProfileOnboardingModalOutside();
