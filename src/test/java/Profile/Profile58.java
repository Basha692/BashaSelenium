...
public class Profile58 extends OnboardingModalsTest {
	...
	public void ValidateProfileOnboardingModal(String placeholderValues) throws Exception {
		try {
			test.log(LogStatus.INFO, "update firsname and lastname on profile Onboarding modals for first time users");
			pf.getOnboardingModalsPageInstance(ob).updateNameOnProfileOnboardingModal(placeholderValues);
