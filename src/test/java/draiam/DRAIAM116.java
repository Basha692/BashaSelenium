...
public class DRAIAM116 extends TestBase {
	...
	public void testcaseDRA1() throws Exception {
		...
		try {
			...
			pf.getDraSSOPageInstance(ob).loginDRAApp(LOGIN.getProperty("DRADTSSOUSERNAME"),
					LOGIN.getProperty("DRADTSSOPASSWORD"));
			waitUntilText("Explore targets");
			String currUrl = ob.getCurrentUrl();
			Assert.assertEquals(currUrl, "https://apps.dev-stable.clarivate.com/dra-td/#/home");
