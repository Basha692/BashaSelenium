...
/**
 * Verify that user is able to delete a watchlist||Verify that user is not able to see his watchlist on his own profile
 * page once that particular watchlist is deleted.
 * 
