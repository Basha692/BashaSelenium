...
public enum OnePObjectMap {
	...
	ENW_HEADER_XPATH("//img[@id='trlogo']"),
	...
	COMMON_FEEDBACK_SUBMIT_BTN_XPATH("//button[@name='hook']"),
	...
	HOME_PROJECT_NEON_PROFILE_TERMS_OF_USE_LINK_CSS("a[data-event-action='terms']"),
	...
	HOME_PROJECT_NEON_ARTICLE_RECORD_VIEW_FB_USERNAME_NAME("email"),
	HOME_PROJECT_NEON_ARTICLE_RECORD_VIEW_FB_PASSWORD_CSS("input#pass"),
	HOME_PROJECT_NEON_ARTICLE_RECORD_VIEW_FB_PASSWORD_XPATH("//input[@name='pass']"),
	...
	HOME_PROJECT_NEON_PROFILE_HELP_LINK_CSS("a[data-event-action='help-feedback']"),	
	...
	HOME_PROJECT_NEON_PROFILE_PICTURE_SELECT_IMAGE_LINK("Select an image"),
	...
	HOME_PROJECT_NEON_PROFILE_POST_TITLE_CSS("h3[class^='wui-content-title']"),
	...
	NEWSFEED_TRENDINDING_TOPICS_LINKS_XPATH("//ne-trending-categories[@class='ng-scope ng-isolate-scope']//li[2]//a"),
	...
	NEWSFEED_TRENDINDING_DOCUMENT_TITLES_XPATH("//div[@class='tab-content']//li/div/h4"),
	...
	SEARCH_RESULT_PAGE_SORT_DROPDOWN_CSS("button[id*='dropdown__toggle']"),
	...
	PASSWORD_RESET_PAGE_PASSWORD_ERROR_MESSAGE_CSS("p[class='wui-input-with-label__error--reset-password ng-binding']"),
	...
	LOGIN_PAGE_FB_SIGN_IN_BUTTON_CSS("i[class='fa fa-facebook share-menu-icon']"),
	LOGIN_PAGE_GMAIL_SIGN_IN_BUTTON_CSS("i[class='fa fa-google share-menu-icon']"),
	LOGIN_PAGE_GMAIL_SIGN_IN_EMAIL_TEXT_NAME("Email"),
	LOGIN_PAGE_GMAIL_SIGN_IN_NEXT_BUTTON_ID("next"),
	...
	LOGIN_PAGE_FB_PASSWORD_TEXT_BOX_NAME("pass"),
	LOGIN_PAGE_FB_LOGIN_BUTTON_ID("loginbutton"),
	LOGIN_PAGE_FB_LOGIN_BUTTON_NAME("login"),
	...
	ENWLANDINGPAGE_CREATE_ICON_CSS("i[class='fa fa-cogs login-splash-icon']"),
	ENWLANDINGPAGE_ORGANIZE_ICON_CSS("i[class='fa fa-users login-splash-icon']"),
	...
	ACCOUNT_STEAM_EMAILID_NAME("email"),
	ACCOUNT_STEAM_PASSWORD_NAME("password"),
	...
	DRA_INVALIDCREDENTIALS_ERRORMSG_CSS("label[class='form-level-error__message-text']"),
	...
	IPA_PROFILE_FLYOUT_IMAGE_CSS("img[class='wui-circle']"),
	IPA_PROFILE_FLYOUT_USERNAME_XPATH("//button[@class='wui-modal__close-btn']"),
	...
	IPA_CC_NAME_CSS("input[ng-model='vm.firstName']"),
	...
	// #################### CUSTOMER CARE ##########################
	CUSTOMER_CARE_USER_NAME_XPATH("//input[@name='login']"),
	CUSTOMER_CARE_PASSWORD_XPATH("//input[@name='password']"),
	CUSTOMER_CARE_CLICK_LOGIN_BUTTON_XPATH("//input[@name='GO']"),
	...
	CUSTOMER_CARE_LINK_LANDINGPAGE_CSS("a[href='https://support.clarivate.com/LifeSciences/']"),
	CUSTOMER_CARE_SUPPORTLINK_FEEDBACK_CSS("a[href*='https://apps.clarivate.com/cmty/#/customer-care?app=dra']"),
	CUSTOMER_CARE_SUPPORTLINK_HELP_CSS("a[href='/cmty/#/customer-care?app=dra']"),
	CUSTOMER_CARE_SUPPORTREQUEST_NAME_CSS("input[name='firstName']"),
	CUSTOMER_CARE_SUPPORTREQUEST_ORG_CSS("input[name='organization']"),
	CUSTOMER_CARE_SUPPORTREQUEST_EMAIL_CSS("input[name='email']"),
	...
	CUSTOMER_CARE_USER_FIRSTNAME_NAME("firstName"),
	CUSTOMER_CARE_USER_LASTNAME_NAME("lastName"),
	...
	WAT_AUTHOR_RECORD_PUBLICATIONS_XPATH("(//div[@class='wui-card__content'])[3]/descendant::div[@class='wui-descriptor wat-search-results-publications-authors wat-author-record-publications-authors']"),
	WAT_AUTHOR_RECORD_PUBLICATIONS_MORE_LINK_XPATH("//a[@class='wat-author-record-publications-author wat-author-record-publications-author__more-less']"),
	
	WAT_AUTHOR_RECORD_FIRST_PUBLICATION_REMOVE_BTN_XPATH("(//button[@aria-label='Remove'])[1]"),
	WAT_AUTHOR_RECORD_SECOND_PUBLICATION_REMOVE_BTN_XPATH("(//button[@aria-label='Remove'])[2]"),
	...
	//-- Gmail locators
	GMAIL_LOGIN_CSS("input[type='email']"),
	GMAIL_LOGIN_NEXT_XPATH("//span[text()='Next']"),
	GMAIL_PASSWORD_CSS("input[type='password']"),
	GMAIL_PASSWORD_NEXT_XPATH("//span[text()='Next']"),
