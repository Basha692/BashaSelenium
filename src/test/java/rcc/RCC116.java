...
/**
 * The RCC113 program covers Add Article/Patent/Post to Multiple Groups from Watchlist Page
 * @author Chinna
 * 
 */
public class RCC116 extends TestBase {
	...
	public void createTwonNewGroups() throws Exception {
	 ...
	 * @throws Exception
	 */
	@Test(dependsOnMethods="createTwonNewGroups")
	@Parameters("watchlistTitle") 
	public void addDocumentToMultipleGroupsFromWatchlistPage(String watchlistTitle) throws Exception {
