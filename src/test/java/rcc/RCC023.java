	...
	public void testGroupCreation() throws Exception {
		...
		try {
			...
			try {
				...
				logFailureDetails(test, t, "GD doc desc and title updated date is displayed correctly for patent",
			...
			try {
				Assert.assertEquals(
						...
						gdDocDesc);
				test.log(LogStatus.PASS, "GD doc desc and title updated correctly for patent");
			} catch (Throwable t) {
				logFailureDetails(test, t, "GD doc desc and title is not updated correctly for patent",
						"_GD_title_dec_not_updated");
			...
			try {
				...
				test.log(LogStatus.PASS, "GD doc timestamp is displayed correctly for patent");
			} catch (Throwable t) {
				logFailureDetails(test, t, "GD doc timestamp is not displayed correctly for patent",
						"_GD_title_dec_not_updated");
			...
			try {
				...
				test.log(LogStatus.PASS, "GD doc is opened correctly for patent");
			} catch (Throwable t) {
				logFailureDetails(test, t, "GD doc is not opened correctly for patent", "_GD_title_dec_not_updated");
			...
			// // gPassword2);
			// pf.getGmailLoginPage(ob).signinGoogleWithoutSwitchingWindow(gUsername2,
			// gPassword2);
			// pf.getGmailLoginPage(ob).clickonGoogleContinue();
			// } catch (Throwable t) {
			// logFailureDetails(test, t, "Successfully Logged in clearing all
			// the privacy things in google.",
			// "Not logged in ");
			// }
