...
public class Notifications0026 extends TestBase {
	...
	public void testcaseF10() throws Exception {
		...
		try {
			...
			List<WebElement> listOfArticles = ob
					.findElements(By.cssSelector(OnePObjectMap.TRENDING_SECTION_POST_FROM_NEWSFEED_CSS.toString()));
			...
			try {
				...
				test.log(LogStatus.INFO,
						"Record view page is open while clicking post in trending section from Newsfeed page");
				test.log(LogStatus.PASS, "PASS");
				closeBrowser();
			} catch (Throwable t) {
				test.log(LogStatus.FAIL,
						"Record view page is not open while clicking post in trending section from Newsfeed page");
				// reports
