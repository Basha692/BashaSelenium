	...
	public void testPostCreation() throws Exception {
		...
		try {
			...
			try {
				...
				test.log(LogStatus.PASS, "All the controls are displayed in post cancel modal");
			} catch (Throwable t) {
				test.log(LogStatus.FAIL, "All the controls are not displayed in post cancel modal");
