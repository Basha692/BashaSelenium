...
/**
 * Class for Verify that System displays the author's last known organization (when available).
 * Verify that System displays the author's last know sub-organization (when available).
 * @author UC202376
 *
 */
public class WAT162 extends TestBase {
