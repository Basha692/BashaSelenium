 ...
 *
 */
public class WAT155 extends TestBase {
	...
	@Parameters({"rid1","errMsg1","rid2","errMsg2","rid3"})
	public void InvalidRIDPatternSearchErrorMessages(String rid1,String errMsg1,String rid2,String errMsg2,String rid3) throws Exception {

		try {
			test.log(LogStatus.INFO, "Entering Invalid RID Pattern");
			pf.getSearchAuthClusterPage(ob).InvaidRIDSearchErrorMsgVaidation(rid1, errMsg1, test);
			...
			logFailureDetails(test, t, "Error Message Not displayed Invalid RID Patterns","Invalid_RID_Search_Pattern_Error_Message");
			pf.getBrowserActionInstance(ob).closeBrowser();
		}
	}
