...
/**
 * Class for Verify that System must display an alternatives name tab after combine 2 or more records
 * @author UC202376
 */
public class WAT180 extends TestBase {
	...
	/**
	 * Method for validate alternative names tab in Author Record page for combined author 
	 * 
	 * @param lastName
	 * @throws Exception, When Something unexpected
	 */
	...
	public void authorRecordPageAlternativeNameTab(String lastName) throws Exception {
		...
		try {
			...
			test.log(LogStatus.INFO, "Verify Alternative names tab displayed in author record page");
			...
			logFailureDetails(test, t, "Alternative names tab not displaying in combined author record page",
					"combined_author_alternative_names_tab");
			pf.getBrowserActionInstance(ob).closeBrowser();
		}
