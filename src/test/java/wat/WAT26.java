...
/**
 * Class to test Publication details if count is morthan 1
 * 
 * @author UC202376
 *
 */
public class WAT26 extends TestBase {
	...
	public void testAuthorClusterPublicationDetailsMore(String lastName,String countryName,String orgName) throws Exception {
		...
		try {
			...
			test.log(LogStatus.PASS, "Publication Details if count is morethan 1 is displyed successfully");
			pf.getBrowserActionInstance(ob).closeBrowser();
