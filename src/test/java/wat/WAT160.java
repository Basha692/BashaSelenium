...
/**
 * Class for Verify that System must display the department name (sub-organization) in addition to the institution/org name.
 * Verify that System must display the sub-organization below the Organization name
 * @author UC202376
 *
 */
public class WAT160 extends TestBase {
