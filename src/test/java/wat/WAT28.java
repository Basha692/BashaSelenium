...
/**
 * Class for Verify author search results in people cart i.e. First name Last name Alternative name(s) Number of
 * publications Organization City/state/country (when available). Journal Details
 * 
 * @author UC202376
 *
 */
public class WAT28 extends TestBase {
	...
	/**
	 * Method for Search Author cluster Results in each cart
	 * 
	...
	public void publicationFieldsinEachClusterResult(String lastName,String countryName,String orgName) throws Exception {
