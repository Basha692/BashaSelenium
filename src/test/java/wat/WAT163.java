 ...
 *
 */
public class WAT163 extends TestBase {
	...
	@Parameters({"lastName"})
	public void validateCombinedAuthorLocation(String lastName) throws Exception {
		...
		try {
			...
			logFailureDetails(test, t, "Combined Author Location not displayed","Location_not_displayed_Combined_Author");
			pf.getBrowserActionInstance(ob).closeBrowser();
		}
