...
public class WAT59 extends TestBase {
	...
	/**
	 * Method for validate Default Avatar in Author Record page
	 * 
	 * @param lastName
	 * @throws Exception, When Something unexpected
	 */
	...
	@Parameters("lastName")
	public void authorRecordAvatar(String lastName) throws Exception {
