...
/**
 * Class to test Author cluster publication details in cart if count is 1
 * 
 * @author UC202376
 *
 */
public class WAT23 extends TestBase {
	...
	/**
	 * Method for validate publication cart details are displayed for author cluster
	 * 
	...
	public void testSearchAuthorClusterOnlyLastName(String lastName,String countryName,String orgName) throws Exception {
		...
		try {
			...
			logFailureDetails(test, t, "Author Search Results Publication cart for count 1 not displayed", "search_results_fail");
			pf.getBrowserActionInstance(ob).closeBrowser();
		}
