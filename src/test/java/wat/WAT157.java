...
/**
 * Class for Verify that ‘Select All’ option should not display when quantity of search results of an author morethan 50.
 * @author UC202376
 *
 */
public class WAT157 extends TestBase {
	...
	public void selectAllForMorethanFiftryResults(String lastName,String countryName) throws Exception {
