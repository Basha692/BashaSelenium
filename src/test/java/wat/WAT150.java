 ...
 * @author UC202376
 */
public class WAT150 extends TestBase {
	...
	/**
	 * Method for validate Ballon Popover in Author Search page
	 * 
	 * @param lastName
	 * @throws Exception, When Something unexpected
	 */
	...
	public void validateBallonPopover() throws Exception {
		...
		try {
			test.log(LogStatus.INFO, "Validate Ballon Popover Open and Close Behaviour ");
			pf.getSearchAuthClusterPage(ob).ballonPopoverOpenAndClose();
			pf.getBrowserActionInstance(ob).closeBrowser();
		} catch (Throwable t) {
			logFailureDetails(test, t, "Ballon Popover Open and Close not working as expected",
					"Ballon_popover_Fail");
			pf.getBrowserActionInstance(ob).closeBrowser();
		}
