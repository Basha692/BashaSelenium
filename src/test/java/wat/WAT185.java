...
/**
 * Class for Verify that System must display the author's ResearcherID (when available)
 * @author UC202376
 *
 */
public class WAT185 extends TestBase {
	...
	/**
	 * Method for Verify Author RID as displayed as URI
	 * 
	 * @param lastName
	 * @throws Exception, When Something unexpected
	 */
	...
	public void validateCombinedAuthorORCiD(String lastName,String authorName) throws Exception {
		...
		try {
			...
			logFailureDetails(test, t, "Author's RID not displayed as a URI","Author_rid_URI_fail");
			pf.getBrowserActionInstance(ob).closeBrowser();
		}
