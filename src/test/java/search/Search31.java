...
public class Search31 extends TestBase {
	...
	public void testcaseB8() throws Exception {
		...
		try {
			...
			List<WebElement> content_types = ob.findElements(By.cssSelector("a[class='wui-side-menu__link']"));
			...
			if (!text1.contains("All") || !text2.contains("Articles") || !text3.contains("Patents")
				...
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(
						this.getClass().getSimpleName() + "some_content_types_are_missing_in_result_page")));// screenshot
