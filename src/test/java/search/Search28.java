...
public class Search28 extends TestBase {
	...
	@Test
	public void testcaseB28() throws Exception {
		...
		try {
			...
			if (!compareNumbers(4, al.size())) {
				...
				test.log(LogStatus.INFO,
						"Snapshot below: " + test.addScreenCapture(captureScreenshot(this.getClass().getSimpleName()
								+ "_moreor_less_than_four_article_suggestions_getting_displayed")));// screenshot
			}
			...
			if (!compareNumbers(0, count)) {
				...
				test.log(LogStatus.INFO, "Snapshot below: " + test.addScreenCapture(captureScreenshot(
						this.getClass().getSimpleName() + "_article_suggestion_does_not_contain_typed_keyword")));// screenshot
			}
